...
import { Users, Home, ClipboardList, DollarSign } from 'lucide-react';
...
export default function ManagerDashboard() {
  ...
  const managerActions = [
    {
      title: 'Operations',
      description: 'Manage cleaning, maintenance, and inventory',
      icon: ClipboardList,
      href: '/operations',
      color: 'bg-blue-500'
    },
    {
      title: 'InHouse Management',
      description: 'View and manage current bookings',
      icon: Home,
      href: '/inhouse',
      color: 'bg-green-500'
    },
