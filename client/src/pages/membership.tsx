      ...
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Exclusive membership-only access to our private clubhouse in the heart of Honolulu. Experience privacy, comfort, and convenient accommodation with your membership plan.
          </p>
